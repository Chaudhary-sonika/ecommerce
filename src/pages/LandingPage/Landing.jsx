  ...
  return (
    <div>
      <div className="titleDiv">
        <img
          className="Hero"
          src="https://static0.pocketlintimages.com/wordpress/wp-content/uploads/130383-smart-home-news-feature-how-will-samsung-s-200m-smartthings-purchase-affect-your-house-image5-35ZMJprEi9.png"
          alt="HomePicture"
        />
      ...
      <div className="landingDiv">
        ...
        <div>
          <div className="productLandingDiv">
            {FinalData.map((item) => {
              const { _id, name, category, rating, price, mrp, imageUrl } =
                item;
